...
/**
 * individualfeedback module conversion handler
 */
class moodle1_mod_individualfeedback_handler extends moodle1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /MOODLE_BACKUP/COURSE/MODULES/MOD/individualfeedback does not
    ...
    public function process_individualfeedback($data) {
        ...
        // start writing individualfeedback.xml
        $this->open_xml_writer("activities/individualfeedback_{$this->moduleid}/individualfeedback.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $this->moduleid,
            'modulename' => 'individualfeedback', 'contextid' => $contextid));
        $this->xmlwriter->begin_tag('individualfeedback', array('id' => $instanceid));
    ...
    /**
     * This is executed when we reach the closing </MOD> tag of our 'individualfeedback' path
     */
    public function on_individualfeedback_end() {
        // finish writing individualfeedback.xml
        $this->xmlwriter->end_tag('items');
        $this->xmlwriter->end_tag('individualfeedback');
