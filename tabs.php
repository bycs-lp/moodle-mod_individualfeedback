...
if ($feedback->course == SITEID && has_capability('mod/individualfeedback:mapcourse', $context)) {
...
if (has_capability('mod/individualfeedback:viewreports', $context)) {
    ...
    if ($feedback->anonymous == INDIVIDUALFEEDBACK_ANONYMOUS_NO AND $feedback->course != SITEID) {
