...
final class dates_test extends advanced_testcase {
     ...
     * @param int|null $timeopen The "allow answers from" time in the individualfeedback activity.
     * @param int|null $timeclose The "allow answers to" time in the individualfeedback activity.
