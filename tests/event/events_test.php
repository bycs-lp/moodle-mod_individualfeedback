...
final class events_test extends \advanced_testcase {
    ...
    /** @var  stdClass An individualfeedback activity used for event testing. */
    private $eventindividualfeedback;

    /** @var  stdClass course module object . */
    private $eventcm;

    /** @var  stdClass An individualfeedback item. */
    private $eventindividualfeedbackitem;

    /** @var  stdClass An individualfeedback activity response submitted by user. */
    ...
    public function setUp(): void {
        ...
        // Add an individualfeedback activity to the created course.
        $record = new \stdClass();
        ...
        // Create an individualfeedback item.
        $item = new \stdClass();
    ...
    public function test_response_deleted_event(): void {
        ...
        // Save the individualfeedback response.
        $sink = $this->redirectEvents();
