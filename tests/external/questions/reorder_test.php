...
/**
 * Unit tests of external class for re-ordering individualfeedback question items
 *
...
final class reorder_test extends \advanced_testcase {
    ...
    public function test_execute(): void {
        ...
        // Create a course with a individualfeedback activity and some questions.
    ...
    /**
     * Get the order of the individualfeedback items.
     *
