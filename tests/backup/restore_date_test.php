...
final class restore_date_test extends \restore_date_testcase {
    ...
    public function test_restore_dates(): void {
        ...
        $response->individualfeedback = $feedback->id;
        ...
        $newresponse = $DB->get_record('individualfeedback_completed', ['individualfeedback' => $newfeedback->id]);
    ...
    public function test_restore_item_dependency(): void {
        ...
        $restoreditem1 = $DB->get_record('individualfeedback_item', ['individualfeedback' => $restoredfeedback->id, 'name' => $item1->name]);
        $restoreditem2 = $DB->get_record('individualfeedback_item', ['individualfeedback' => $restoredfeedback->id, 'name' => $item2->name]);
        ...
        $restoreditem3 = $DB->get_record('individualfeedback_item', ['individualfeedback' => $restoredfeedback->id, 'name' => $item3->name]);
