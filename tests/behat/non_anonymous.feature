...
Feature: Non anonymous individualfeedback
  In order to collect individualfeedbacks
  As an teacher
  I need to be able to create and collect individualfeedbacks
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | individualfeedback   | Site individualfeedback   | Acceptance test site | individualfeedback0 | 2         | 1             | 1       |
      | individualfeedback   | Course individualfeedback | C1                   | individualfeedback1 | 2         | 1             | 0       |
    When I am on the "Site individualfeedback" "individualfeedback activity" page logged in as manager
  ...
  Scenario: Guests can see non anonymous individualfeedback on front page but can not complete
    When I am on the "Site individualfeedback" "individualfeedback activity" page
    Then I should not see "Answer the questions"
    And I should not see "Preview questions"

  Scenario: Complete non anonymous individualfeedback on the front page as an authenticated user
    When I am on the "Site individualfeedback" "individualfeedback activity" page logged in as user1
    And I should not see "Preview questions"
  ...
  @javascript
  Scenario: Complete non anonymous individualfeedback and view analysis on the front page as an authenticated user
    ...
    And I press "Submit your answers"
    And I log out
    And I am on the "Site individualfeedback" "individualfeedback activity" page logged in as user2
    And I follow "Answer the questions"
    And I set the following fields to these values:
      | Not at all | 1 |
    And I press "Submit your answers"
    ...
    And I log out
    And I am on the "Site individualfeedback" "individualfeedback activity" page logged in as manager
  ...
  @javascript
  Scenario: Non anonymous individualfeedback in a course
    ...
    And I press "Submit your answers"
    And I log out
    When I am on the "Course individualfeedback" "individualfeedback activity" page logged in as user2
    And I follow "Answer the questions"
    And I should see "Do you like this course?"
    And I set the following fields to these values:
      | Not at all | 1 |
    ...
    # Sort the individualfeedback responses.
