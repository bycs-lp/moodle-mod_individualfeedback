...
Feature: Test creating different types of individualfeedback questions for non-anonymous individualfeedback
  In order to create individualfeedbacks
  As a teacher
  I need to be able to add different question types

  @javascript
  Scenario: Create different types of questions in non-anonymous individualfeedback with javascript enabled
    ...
    And the following "activities" exist:
      ...
      | individualfeedback   | Learning experience | C1     | individualfeedback0   | 2         |
    When I am on the "Learning experience" "individualfeedback activity" page logged in as teacher1
    ...
    And I log out
    When I am on the "Learning experience" "individualfeedback activity" page logged in as student1
    ...
    And I log out
    When I am on the "Learning experience" "individualfeedback activity" page logged in as student2
    And I follow "Answer the questions"
    And I set the following fields to these values:
