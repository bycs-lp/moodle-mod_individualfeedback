...
Feature: Show users who have not responded to the individualfeedback survey
  In order to harass students about completing the individualfeedback
  As a teacher
  ...
  Scenario: See users who have not responded
    ...
    And I am on the Frogs "individualfeedback activity" page logged in as teacher1
