...
Feature: Individualfeedback with no calendar capabilites
  ...
  Scenario: Editing a individualfeedback
    Given the following "activities" exist:
      | activity   | name                   | intro                         | course | idnumber    |
      | individualfeedback   | Test individualfeedback name     | Test individualfeedback description     | C1     | individualfeedback1   |
    And I log in as "admin"
