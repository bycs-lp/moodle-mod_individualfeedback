...
Feature: Testing multichoice questions in individualfeedback
  ...
  Background:
    ...
    And I am on the "Learning experience" "individualfeedback activity" page logged in as teacher1
    And I navigate to "Questions" in current page administration

  @javascript
  Scenario: Non-rated single-answer multiple choice questions in individualfeedback
    When I add a "Multiple choice" question to the individualfeedback with:
    ...
    And I add a "Text and media area" question to the individualfeedback with:
      | Contents | this is the first page of the individualfeedback |
    ...
    And I add a "Multiple choice" question to the individualfeedback with:
      ...
      | Required | 1 |
    And I add a "Text and media area" question to the individualfeedback with:
      | Contents | this is the second page of the individualfeedback |
    And I add a page break to the individualfeedback
    And I add a "Multiple choice" question to the individualfeedback with:
    ...
    And I add a "Text and media area" question to the individualfeedback with:
      | Contents | this is the third page of the individualfeedback |
    And I log out
    And I am on the "Learning experience" "individualfeedback activity" page logged in as student1
    ...
    And I should see "this is the first page of the individualfeedback"
    And I should not see "this is the second page of the individualfeedback"
    And I should not see "this is the third page of the individualfeedback"
    ...
    And "Submit your answers" "button" should not exist
    And I should not see "this is the first page of the individualfeedback"
    And I should see "this is the second page of the individualfeedback"
    And I should not see "this is the third page of the individualfeedback"
    And I press "Next page"
    ...
    And I should see "this is the third page of the individualfeedback"
    ...
    And I am on the "Learning experience" "individualfeedback activity" page logged in as student2
    And I follow "Answer the questions"
    ...
    And I show chart data for the "multichoice3" individualfeedback
    ...
    And I am on the "Learning experience" "individualfeedback activity" page
    And I navigate to "Questions" in current page administration
  ...
  @javascript
  Scenario: Non-rated multiple-answers multiple choice questions in individualfeedback
    # Create a individualfeedback with three pages, required and dependent questions.
    When I add a "Multiple choice" question to the individualfeedback with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
  ...
  @javascript
  Scenario: Non-rated single-answer dropdown multiple choice questions in individualfeedback
    When I add a "Multiple choice" question to the individualfeedback with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
