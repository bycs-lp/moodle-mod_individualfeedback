...
$functions = array(
    ...
    'mod_individualfeedback_get_individualfeedbacks_by_courses' => array(
        ...
        'description'   => 'Returns a list of individualfeedbacks in a provided list of courses, if no list is provided all
                            individualfeedbacks that the user can view will be returned.',
        'type'          => 'read',
    ...
    'mod_individualfeedback_launch_individualfeedback' => array(
        ...
        'description'   => 'Starts or continues an individualfeedback submission.',
        'type'          => 'write',
    ...
    'mod_individualfeedback_questions_reorder' => [
        ...
        'description'   => 'Saves the new order of the questions in the individualfeedback.',
        'type'          => 'write',
        'ajax'          => true,
