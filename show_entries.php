...
if ($userid || $showcompleted) {
    ...
    echo html_writer::start_div('individualfeedback_response_navigation');

    // Add link to all responses as supplementary content to go to the main Responses page.
    $PAGE->set_supplementary_content(
        new action_link(
            $returnurl,
            get_string('gotoallresponses', 'mod_individualfeedback'),
        )
    );
    ...
    $buttons[] = [
        ...
        'title' => get_string('prevresponse', 'mod_individualfeedback'),
        'arialabel' => get_string('prevresponse', 'mod_individualfeedback'),
    ...
    $buttons[] = [
        ...
        'title' => get_string('nextresponse', 'mod_individualfeedback'),
        'arialabel' => get_string('nextresponse', 'mod_individualfeedback'),
        'disabled' => !$nextresponseurl,
    ];
    echo $OUTPUT->render_from_template('mod_individualfeedback/responses_navigation', ['navbuttons' => $buttons]);
