...
$string['bold'] = 'Bold';
$string['browseresponses'] = 'Browse responses';
...
$string['gotoallresponses'] = 'Go to all responses';
...
$string['nextresponse'] = 'Next response';
...
$string['prevresponse'] = 'Previous response';
