...
class mod_individualfeedback_external extends external_api {
     ...
     * @since  Moodle 3.3
     */
    protected static function validate_individualfeedback($individualfeedbackid, $courseid = 0) {
        global $DB, $USER;
    ...
    public static function get_individualfeedback_access_information($individualfeedbackid, $courseid = 0) {
        ...
        list($individualfeedback, $course, $cm, $context, $completioncourse) = self::validate_individualfeedback($params['individualfeedbackid'],
            $params['courseid']);
     ...
     * @param int $courseid course where user completes a individualfeedback (for site individualfeedbacks only).
