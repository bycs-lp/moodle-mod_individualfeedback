...
class mod_individualfeedback_external extends external_api {
    ...
    public static function get_individualfeedbacks_by_courses($courseids = array()) {
        ...
        $result = array(
            'individualfeedbacks' => $returnedfeedbacks,
            'warnings' => $warnings
        );
        return $result;
    }
    ...
    /**
     * Utility function for validating an individualfeedback.
     *
     * @param int $individualfeedbackid individualindividualfeedback instance id
     * @param int $courseid courseid course where user completes the individualfeedback (for site individualfeedbacks only)
     * @return array containing the individualfeedback, individualfeedback course, context, course module and the course where is being completed.
     * @throws moodle_exception
     * @since  Moodle 3.3
     */
    protected static function validate_feedback($individualfeedbackid, $courseid = 0) {
        global $DB, $USER;

        // Request and permission validation.
        $individualfeedback = $DB->get_record('individualfeedback', array('id' => $individualfeedbackid), '*', MUST_EXIST);
        list($individualfeedbackcourse, $cm) = get_course_and_cm_from_instance($individualfeedback, 'individualfeedback');
        ...
        if ($individualfeedbackcourse->id == SITEID && $courseid) {
            ...
            if (!$individualfeedbackcompletion->check_course_is_mapped()) {
                throw new moodle_exception('cannotaccess', 'mod_individualfeedback');
            }
        }

        return array($individualfeedback, $individualfeedbackcourse, $cm, $context, $completioncourse);
    }
     ...
     * @param  stdClass   $course   course where user completes the individualfeedback (for site individualfeedbacks only)
     * @param  stdClass   $cm       course module
     * @param  stdClass   $context  context object
     * @throws moodle_exception
     * @return mod_individualfeedback_completion individualfeedback completion instance
     * @since  Moodle 3.3
     */
    ...
    public static function get_individualfeedback_access_information_parameters() {
        return new external_function_parameters (
            array(
                'individualfeedbackid' => new external_value(PARAM_INT, 'Feedback instance id.'),
                'courseid' => new external_value(PARAM_INT, 'Course where user completes the individualfeedback (for site individualfeedbacks only).',
                    VALUE_DEFAULT, 0),
            )
        );
    }
     ...
     *
     * @param int $individualfeedbackid individualindividualfeedback instance id
     * @param int $courseid course where user completes the individualfeedback (for site individualfeedbacks only)
     * @return array of warnings and the access information
     * @since Moodle 3.3
     * @throws  moodle_exception
     */
    public static function get_individualfeedback_access_information($individualfeedbackid, $courseid = 0) {
        global $PAGE;
        ...
        list($individualfeedback, $course, $cm, $context, $completioncourse) = self::validate_feedback($params['individualfeedbackid'],
            $params['courseid']);
        $individualfeedbackcompletion = new mod_individualfeedback_completion($individualfeedback, $cm, $completioncourse->id);
     ...
     * @throws moodle_exception
     */
    public static function view_individualfeedback($individualfeedbackid, $moduleviewed = false, $courseid = 0) {

        $params = array('individualfeedbackid' => $individualfeedbackid, 'moduleviewed' => $moduleviewed, 'courseid' => $courseid);
     ...
     * @throws moodle_exception
     */
    public static function get_current_completed_tmp($individualfeedbackid, $courseid = 0) {
        global $PAGE;
     ...
     * @since Moodle 3.3
     */
    public static function get_items($individualfeedbackid, $courseid = 0) {
        global $PAGE;
        ...
        $userhasaccess = true;
        try {
            // Check the user has access to the individualfeedback.
            self::validate_individualfeedback_access($individualfeedback, $completioncourse, $cm, $context, true);
        } catch (moodle_exception $e) {
            $userhasaccess = false;
            $warnings[] = [
                'item' => $individualfeedback->id,
        ...
        if ($userhasaccess || has_any_capability($capabilities, $context)) {
            ...
            $warnings = [];
            $individualfeedbackstructure = new mod_individualfeedback_structure($individualfeedback, $cm, $completioncourse->id);
    ...
    /**
     * Starts or continues an individualfeedback submission
     *
     * @param array $individualfeedbackid individualfeedback instance id
     * @param int $courseid course where user completes an individualfeedback (for site individualfeedbacks only).
     * @return array of warnings and launch information
     * @since Moodle 3.3
     */
    public static function launch_individualfeedback($individualfeedbackid, $courseid = 0) {
        global $PAGE;
        ...
        $individualfeedbackcompletion = self::validate_individualfeedback_access($individualfeedback, $completioncourse, $cm, $context, true);
     ...
     * @since Moodle 3.3
     */
    public static function get_page_items($individualfeedbackid, $page, $courseid = 0) {
        global $PAGE;

        $params = array('individualfeedbackid' => $individualfeedbackid, 'page' => $page, 'courseid' => $courseid);
        ...
        $userhasaccess = true;
        $individualfeedbackcompletion = null;
        try {
            // Check the user has access to the individualfeedback.
            $individualfeedbackcompletion = self::validate_individualfeedback_access($individualfeedback, $completioncourse, $cm, $context, true);
        } catch (moodle_exception $e) {
        ...
        if ($userhasaccess || has_any_capability($capabilities, $context)) {
            ...
            if ($individualfeedbackcompletion == null) {
                $individualfeedbackcompletion = new mod_individualfeedback_completion($individualfeedback, $cm, $completioncourse->id);
            }
     ...
     * @since Moodle 3.3
     */
    public static function process_page($individualfeedbackid, $page, $responses = [], $goprevious = false, $courseid = 0) {
        global $USER;
     ...
     * @since Moodle 3.3
     */
    public static function get_analysis($individualfeedbackid, $groupid = 0, $courseid = 0) {
        global $PAGE;

        $params = array('individualfeedbackid' => $individualfeedbackid, 'groupid' => $groupid, 'courseid' => $courseid);
     ...
     * @since Moodle 3.3
     */
    public static function get_unfinished_responses($individualfeedbackid, $courseid = 0) {
        global $PAGE;
     ...
     * @since Moodle 3.3
     */
    public static function get_finished_responses($individualfeedbackid, $courseid = 0) {
        global $PAGE;
    ...
    public static function get_non_respondents($individualfeedbackid, $groupid = 0, $sort = 'lastaccess', $page = 0, $perpage = 0,
        ...
        $params = array('individualfeedbackid' => $individualfeedbackid, 'groupid' => $groupid, 'sort' => $sort, 'page' => $page,
        ...
        list($individualfeedback, $course, $cm, $context, $completioncourse) = self::validate_feedback($params['individualfeedbackid'],
            $params['courseid']);
        $individualfeedbackcompletion = new mod_individualfeedback_completion($individualfeedback, $cm, $completioncourse->id);
        $completioncourseid = $individualfeedbackcompletion->get_courseid();
     ...
     * @since Moodle 3.3
     */
    public static function get_responses_analysis($individualfeedbackid, $groupid = 0, $page = 0, $perpage = 0, $courseid = 0) {
     ...
     * @throws moodle_exception
     */
    public static function get_last_completed($individualfeedbackid, $courseid = 0) {
        global $PAGE;
