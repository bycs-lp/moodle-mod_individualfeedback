...
class compare {
    ...
    public static function render(\stdClass $individualfeedback, $cm, int $id, moodle_url $url, bool $compact = false): void {
        ...
        // Use a real renderer: the lazy $OUTPUT is a bootstrap_renderer in CLI
        // and unit tests, which does not satisfy the renderer_base type of
        // core's summary::export_for_template().
        ...
        echo $renderer->render_from_template('mod_individualfeedback/summary', $summary->export_for_template($renderer));
