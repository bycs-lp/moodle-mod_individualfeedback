...
class provider implements
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        $params = ['modulename' => 'individualfeedback', 'modlevel' => CONTEXT_MODULE, 'userid' => $userid];
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        $params = ['modulename' => 'individualfeedback', 'modlevel' => CONTEXT_MODULE, 'contextid' => $context->id];
        ...
        $completedsql = "
            SELECT fc.id
              ...
              JOIN {course_modules} cm
               ...
               AND cm.module = m.id
             WHERE cm.id = :cmid";
        $completedparams = ['cmid' => $context->instanceid, 'modulename' => 'individualfeedback'];
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        $completedsql = "
            SELECT fc.id
             ...
             WHERE fc.userid = :userid
               AND cm.id $insql";
        $completedparams = array_merge($inparams, ['userid' => $userid, 'modulename' => 'individualfeedback']);
        ...
        $completedsql = "
            SELECT fc.id
             ...
             WHERE cm.id = :instanceid
               AND fc.userid $insql";
        $completedparams = array_merge($inparams, ['instanceid' => $context->instanceid, 'modulename' => 'individualfeedback']);
