...
// Get the completeds.
$completedscount = $individualfeedbackstructure->count_completed_responses($mygroupid);
...
$worksheet1->write_string($rowoffset1,
    0,
    get_string('completed_individualfeedbacks', 'individualfeedback').': '.strval($completedscount),
    $xlsformats->head1);
