...
class individualfeedback_item_textfield extends individualfeedback_item_base {
    ...
    public function build_editform($item, $individualfeedback, $cm) {
        ...
        $this->item_form = new individualfeedback_textfield_form('edit_item.php', $customdata);
    }
