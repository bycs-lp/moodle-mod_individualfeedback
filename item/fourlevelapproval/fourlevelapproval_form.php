...
class individualfeedback_fourlevelapproval_form extends individualfeedback_item_form {
    ...
    public function definition() {
        ...
        $mform->addElement(
            ...
            ['size' => INDIVIDUALFEEDBACK_ITEM_NAME_TEXTBOX_SIZE,
            'maxlength' => 255]
        );
        ...
        $mform->addElement(
            ...
            ['size' => INDIVIDUALFEEDBACK_ITEM_LABEL_TEXTBOX_SIZE,
            'maxlength' => 255]
        );
        ...
        $mform->addElement('select',
                            'subtype',
                            get_string('fourlevelapprovaltype', 'individualfeedback').'&nbsp;',
        ...
        */
        ...
        $mform->addElement(
            ...
            [0 => get_string('vertical', 'individualfeedback'),
            1 => get_string(
                'horizontal',
                'individualfeedback'
            )]
    ...
    public function get_data() {
        ...
        $presentation = str_replace("\n", INDIVIDUALFEEDBACK_FOURLEVELAPPROVAL_LINE_SEP, trim($item->values));
        ...
        if (isset($item->horizontal) and $item->horizontal == 1 and $subtype != 'd') {
            $presentation .= INDIVIDUALFEEDBACK_FOURLEVELAPPROVAL_ADJUST_SEP . '1';
        }
        ...
        $item->presentation = $subtype . INDIVIDUALFEEDBACK_FOURLEVELAPPROVAL_TYPE_SEP . $presentation;
        return $item;
    }
}
