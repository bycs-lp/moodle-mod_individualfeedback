...
class individualfeedback_fivelevelapproval_form extends individualfeedback_item_form {
    ...
    public function get_data() {
        ...
        $presentation = str_replace("\n", INDIVIDUALFEEDBACK_FIVELEVELAPPROVAL_LINE_SEP, trim($item->values));
        ...
        if (isset($item->horizontal) and $item->horizontal == 1 and $subtype != 'd') {
            $presentation .= INDIVIDUALFEEDBACK_FIVELEVELAPPROVAL_ADJUST_SEP . '1';
        }
