...
class individualfeedback_captcha_form extends individualfeedback_item_form {
    ...
    public function definition() {
        ...
        $mform->addElement('text',
                            ...
                            ['size' => INDIVIDUALFEEDBACK_ITEM_NAME_TEXTBOX_SIZE, 'maxlength' => 1333]);
        $mform->addElement('text',
                            'label',
        ...
        $mform->addElement('select',
                            'presentation',
                            get_string('count_of_nums', 'individualfeedback').'&nbsp;',
